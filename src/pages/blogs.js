...
export default function AllBlogs({ allPostsData }) {
    return (
        <>
            <Head>
                <title>Tech Blogs | JavaScript, NodeJS, React, Angular, Blockchain, DevOps</title>
                <meta name="viewport" content="width=device-width, initial-scale=1" />
                <link rel="icon" href="/favicon.ico" />

                <meta name="title" content="Tech Blogs | JavaScript, NodeJS, React, Angular, Blockchain, DevOps" />
                ...
                <div className="container">
                    ...
                    <div className="cards-section row">
                        {allPostsData.map(({ id, title, description }) => (
                            <Link href={`/blogs/${id}`} key={id} className="text-decoration-none">
                                <div className="basic-blog-card basic-card basic-card-light col-md-6">
