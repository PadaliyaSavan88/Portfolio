      ...
      <main id="main">
        ...
        <section id="about" className="about">
          <div className="container section-fade-up">
            ...
            <div className="section-title">
              <h2>About</h2>
              <p>Welcome to my portfolio! I am a full-stack blockchain developer with a passion for building in the decentralized world. With a strong background in both blockchain technology and web development, I have the skills and experience to create innovative solutions using decentralized platforms. My portfolio showcases my technical abilities as well as my experience in building a wide range of decentralized applications. From smart contract development to building end-to-end decentralized applications, I have a proven track record of delivering results. I am constantly seeking to learn new technologies and push the boundaries of what is possible in the decentralized world. Thank you for visiting my portfolio, I hope you enjoy exploring my work and learning more about my capabilities as a blockchain developer.</p>
            </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-md-12 mt-5 mt-md-0">
                <div className="count-box">
                  ...
                  <span data-purecounter-start="0" data-purecounter-end="1463" data-purecounter-duration="1" className="purecounter">500+</span>
        ...
        <section id="services" className="services">
          <div className="container" data-aos="fade-up">
            ...
            <div className="section-title">
              <h2>Services</h2>
              <p>I am a seasoned web developer with a diverse range of skills in both front-end and back-end development. I am committed to delivering high-quality services to clients and provide exceptional after-service support to ensure their satisfaction. I am well equipped to take on a wide range of projects and deliver results that exceed client expectations.</p>
            </div>
              ...
              <div className="swiper-wrapper">
                ...
                <div className="swiper-slide">
                  <div className="testimonial-item">
                    <Image src="/assets/img/testimonials/testimonials-1.jpg" className="testimonial-img" alt="" width={112} height={112} />
                    <h3>Saul Goodman</h3>
                    <h4>Ceo &amp; Founder</h4>
                    <p>
                ...
                <div className="swiper-slide">
                  <div className="testimonial-item">
                    <Image src="/assets/img/testimonials/testimonials-2.jpg" className="testimonial-img" alt="" width={112} height={112} />
                    <h3>Sara Wilsson</h3>
                    <h4>Designer</h4>
                    <p>
                      <i className="bx bxs-quote-alt-left quote-icon-left"></i>
                ...
                <div className="swiper-slide">
                  <div className="testimonial-item">
                    <Image src="/assets/img/testimonials/testimonials-3.jpg" className="testimonial-img" alt="" width={112} height={112} />
                    <h3>Jena Karlis</h3>
                    <h4>Store Owner</h4>
                    <p>
                      <i className="bx bxs-quote-alt-left quote-icon-left"></i>
                ...
                <div className="swiper-slide">
                  <div className="testimonial-item">
                    <Image src="/assets/img/testimonials/testimonials-4.jpg" className="testimonial-img" alt="" width={112} height={112} />
                    <h3>Matt Brandon</h3>
                    <h4>Freelancer</h4>
                    <p>
                      <i className="bx bxs-quote-alt-left quote-icon-left"></i>
                ...
                <div className="swiper-slide">
                  <div className="testimonial-item">
                    <Image src="/assets/img/testimonials/testimonials-5.jpg" className="testimonial-img" alt="" width={112} height={112} />
                    <h3>John Larson</h3>
                    <h4>Entrepreneur</h4>
                    <p>
                      <i className="bx bxs-quote-alt-left quote-icon-left"></i>
