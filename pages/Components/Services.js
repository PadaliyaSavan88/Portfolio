                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-6 col-md-6 d-flex align-items-stretch">
                            <div className="icon-box iconbox-blue w-100">
                                ...
                                <p>All device responsive web development.</p>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
                            <div className="icon-box iconbox-orange w-100">
                                ...
                                <p>Highly scaleable backend development with monolithic and microservice architechture.</p>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6 col-md-6 d-flex align-items-stretch mt-4">
                            <div className="icon-box iconbox-pink w-100">
                                ...
                                <h4><a href="">DApp Development</a></h4>
                                <p>Full stack decentralised application development</p>
                            </div>
                        </div>

                        <div className="col-lg-6 col-md-6 d-flex align-items-stretch mt-4">
                            <div className="icon-box iconbox-teal w-100">
                                <div className="icon">
                                    <svg width="100" height="100" viewBox="0 0 600 600" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h4><a href="">Smart Contract Development</a></h4>
                                <p>Gas fees optimised smart contract development</p>
                            </div>
                        </div>
